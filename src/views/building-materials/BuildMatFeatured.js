...
class BuildMatFeatured extends Component {
    render() {
        return (
            <>
            <div className="build-mat">
                <div className="container-fluid" style={removePadding}>
                    ...
                    <AwesomeSlider cssModules={Styles}>
                        <div data-src={"./images/sliders/category4.jpg"}>
                        <p>Building Material Caption 1</p>
                        </div>
                        <div data-src={"./images/sliders/building-mat2.jpg"}>
                        <p>Building Material Caption 2</p>
                        </div>
                    </AwesomeSlider>
                    </div>
                    <div className="row" style={SmallMar}>
                        <div className="vt-box-header">
                            <span>Building Materials Sub Categories</span>
                        </div>
...
export default  BuildMatFeatured